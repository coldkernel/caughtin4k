...
__turbopack_context__.s([
    "triggerScan",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$459122__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["triggerScan"]
]);
...
function Dashboard() {
    ...
    const handleScan = async (data)=>{
        ...
        try {
            const scanResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startPublicScan"])({
                target_username: data.username,
                target_gender: data.gender
            });
            if (scanResult.success) {
                // In a real app, we would poll for the result or use the returned data
                // For now, we'll simulate the analysis logs and show a mock result or the returned data if available
                setLogs((prev)=>[
                        ...prev,
                        "TARGET ACQUIRED",
                ...
                setLogs((prev)=>[
                        ...prev,
                        "ERROR: TARGET NOT FOUND OR PRIVATE"
                    ]);
...
//# sourceMappingURL=_881398f8._.js.map
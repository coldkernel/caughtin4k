...
/* __next_internal_action_entry_do_not_use__ [{"40687f0658683bba8c41f8229225cb229dae4ec96f":"startPublicScan","40c714fa66993619ac516bc50de55deee0c837c321":"triggerScan"},"",""] */ __turbopack_context__.s([
    "startPublicScan",
    ()=>startPublicScan,
    "triggerScan",
    ()=>triggerScan
...
;
;
const convex = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$browser$2f$http_client$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ConvexHttpClient"](("TURBOPACK compile-time value", "https://scrupulous-tern-694.convex.cloud"));
...
async function startPublicScan(data) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            try {
                ...
                return {
                    success: false,
                    error: errorJson.detail || response.statusText
                };
            } catch  {
                return {
                    success: false,
                    error: `Microservice Error: ${response.statusText}`
                };
            }
        }
        ...
        // Save to Convex
        try {
            await convex.mutation(__TURBOPACK__imported__module__$5b$project$5d2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["api"].scans.savePublicScan, {
        ...
        return {
            success: false,
            error: "Connection Refused. Is Python running? (Check port 8000)"
        };
    }
}
;
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(startPublicScan, "40687f0658683bba8c41f8229225cb229dae4ec96f", null);
}),
...
__turbopack_context__.s([
    "40687f0658683bba8c41f8229225cb229dae4ec96f",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["startPublicScan"]
]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f4a6937f._.js.map